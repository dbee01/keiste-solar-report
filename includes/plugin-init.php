...
class KSRAD_Plugin {
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('keiste-solar-modal', 'ksradData', array(
            ...
            'defaultElectricityRate' => ksrad_get_option('default_electricity_rate', '0.17'),
            'defaultExportRate' => ksrad_get_option('default_export_rate', '10'),
            'defaultFeedInTariff' => ksrad_get_option('default_feed_in_tariff', '0.15'),
            ...
            'country' => ksrad_get_option('country', 'United States'),
            'systemCostRatio' => ksrad_get_option('system_cost_ratio', '650'),
            'grantRateDomestic' => ksrad_get_option('grant_rate_domestic', '30'),
            'grantCapDomestic' => ksrad_get_option('grant_cap_domestic', '7500'),
            'grantRateNonDomestic' => ksrad_get_option('grant_rate_non_domestic', '30'),
            'grantCapNonDomestic' => ksrad_get_option('grant_cap_non_domestic', '50000'),
            'acaRate' => ksrad_get_option('aca_rate', ''),
